...
export default function RequestVehicleCard({
    ...
    return (
        ...
        {Number(priceResult.termAdjustment) >= 0 ? "+" : ""}
                    ...
                    {/* Separador visual antes de los totales del coche */}
                    <div className="price-divider" style={{borderTop: "1px dashed #ccc", margin: "8px 0"}}></div>
